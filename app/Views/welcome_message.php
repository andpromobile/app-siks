...
<script src="<?php echo base_url('assets/mazer/extensions/apexcharts/apexcharts.min.js')?>"></script>
    <script src="<?php echo base_url('assets/mazer/js/pages/dashboard.js')?>"></script>
